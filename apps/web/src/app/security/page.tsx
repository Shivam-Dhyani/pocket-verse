  ...
  return (
    <div className="pv-app">
      ...
      <article className="pv-page">
        ...
        <ConnectionManager />
        <AccountSecurity />
        {!FORCED_THEME && <AppearanceSetting />}
        <InstallApp />
        ...
        <Accordion>
          ...
          >
            <p>
              ...
              must run while you are logged out, our server can technically decrypt your connection
              key to do that work. What this means in practice:
            </p>
            <ul>
              <li>
          ...
          <AccordionItem summary={<>Telegram-powered storage: what “unlimited” really means</>}>
            <p>
              ...
              space is genuinely unlimited: it is Telegram’s storage, and you own the account it
              lives in. Telegram does limit a <em>single</em> upload to 2&nbsp;GB, so Pocketverse
              quietly splits bigger files into parts and reassembles them when you download — large
              files simply take longer, they are never rejected.
            </p>
          </AccordionItem>

          <AccordionItem summary={<>When files can be lost — and how to prevent it</>}>
            <p>
            ...
            <ul>
              ...
              <li>
                ...
                show or download them, and reconnecting starts with an empty drive. Download
                anything you still need <em>before</em> you disconnect. What was cleared is recorded
                in your activity log.
              </li>
              <li>
                <strong>Touching the storage channel by hand.</strong> If you delete messages from
                the “Pocketverse Storage” channel in the Telegram app — or delete the channel itself
          ...
          <AccordionItem summary={<>Platform fine print</>}>
            <ul>
              <li>
              ...
              <li>
                ...
                sits in a gray area of Telegram’s rules. We believe personal use is reasonable, but
                it is your account — we want you deciding with open eyes.
              </li>
            </ul>
          </AccordionItem>

          <AccordionItem summary={<>Analytics &amp; error monitoring — what we measure</>}>
            <p>
            ...
            <ul>
              ...
              <li>
                Both are off entirely unless configured, and neither can see anything stored in your
                Telegram account.
              </li>
            </ul>
          </AccordionItem>

          <AccordionItem summary={<>Operational practices</>}>
            <ul>
              <li>
